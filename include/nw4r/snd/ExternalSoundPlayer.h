...
namespace nw4r { namespace snd { namespace detail
{
	...
	{
    private:
        typedef ut::LinkList<BasicSound, offsetof(BasicSound, mExtSoundPlayerPlayLink)> ExtSoundPlayerPlayLinkList;
	...
	// members
	private:
		ExtSoundPlayerPlayLinkList              mSoundList;		// size 0x0c, offset 0x00
